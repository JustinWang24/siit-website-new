...
@section('content')
    <div id="" class="content">
        ...
        <div class="columns">
            <div class="column">
                <h2 class="is-size-4">
                    Campus {{ empty($brand->name) ? null : ':'.$brand->name }}
                </h2>
            </div>
            <div class="column">
        ...
        <div class="content">
            <form method="POST" action="{{ url('backend/brands/save') }}" enctype="multipart/form-data">
                ...
                <div class="columns">
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" class="input{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $brand->name }}" required autofocus placeholder="Campus Name: Required">
                                @if ($errors->has('name'))
                                ...
                                <label class="file-label">
                                    ...
                                    <span class="file-cta">
                                        ...
                                        <span class="file-label">
                                          Choose an Image for this Campus
                                        </span>
                                    </span>
                ...
                <div class="field">
                    <label class="label">Extra Info (显示在校区单页中的描述信息)</label>
                    <div class="control">
