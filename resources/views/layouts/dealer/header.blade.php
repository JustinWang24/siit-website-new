<nav class="navbar custom-header" role="navigation" aria-label="main navigation" id="navigation"  style="z-index: 9999;">
    ...
    <div id="navMenu" class="navbar-menu" style="border-bottom: solid 1px #ccc;">
        <div class="navbar-start">
            <a class="navbar-item {{ $menuName=='courses' ? 'is-active' : null }}" href="{{ url('/home') }}">
                <i class="fas fa-cogs"></i>&nbsp;Courses
            </a>
            <a class="navbar-item {{ $menuName=='students' ? 'is-active' : null }}" href="{{ url('/backend/menus/index') }}">
                <i class="fas fa-user"></i>&nbsp;Students
            </a>
            <a class="navbar-item {{ $menuName=='orders' ? 'is-active' : null }}" href="{{ url('/backend/menus/index') }}">
                <i class="far fa-list-alt"></i>&nbsp;Orders
            </a>
            <a class="navbar-item {{ $menuName=='payments' ? 'is-active' : null }}" href="{{ url('/backend/menus/index') }}">
