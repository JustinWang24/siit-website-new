<div class="word-page-style">
    ...
    <p>
        I, <span style="text-decoration: underline;">&nbsp;&nbsp;{{ session('user_data.name') }}&nbsp;&nbsp;</span> have read and understood the pre-enrolment information about the course(s) I am applying for. I have also read and understand the information provided in the Student Handbook regarding SIIT Policies and Procedures and the Student Code of Conduct. I acknowledge that this information has also been made available to me through the SIIT website and/or by emails.
    </p>
    <p>
    I understand that:
    </p>
    ...
    <br>
    <p style="float: left;">
        Student Name (please print): <span style="text-decoration: underline;">&nbsp;&nbsp;&nbsp;{{ session('user_data.name') }}&nbsp;&nbsp;&nbsp;</span>
    </p>
    <p style="float: right;">
