<div class="word-page-style">
    ...
    <ul>
        ...
        <li>Bank cheque made payable to Australian Profesisional Education Institute.</li>
        <li>Transfers by EFTPOS using savings or credit cards. These payment facilities are available from SIIT
            premises. A surcharge fee applies for credit card payments.</li>
    </ul>
