<div class="word-page-style">
    <p style="text-decoration: underline;"><strong>Procedure</strong></p>
    ...
    <p style="padding-left: 16px;">2.	The Student Services Officer will forward this application to Marketing and Client Services Manager who will in coordination with the Finance Manager start processing this application.<p>
    <p style="padding-left: 16px;">3.	Finance Manager and Marketing & Client Services Manager will have a meeting with the CEO. The CEO, based on the evidence provided, will approve or reject the refund request. This decision will be conveyed to the Student Services Officer.<p>
    <p style="padding-left: 16px;">4.	The Student Services Officer will then provide a written outcome to the student regarding the refund application. This feedback is provided within 28 days.<p>
    ...
    <p>If the student chooses placement in another course, SIIT will ask the student to sign a document to indicate that they accept the placement.</p>
    <p>For international students, if SIIT is unable to provide a refund or place the student in an alternative course, SIIT’s Tuition Protection Service (TPS) will place the student in a suitable alternative course at no extra cost to the student.</p>
