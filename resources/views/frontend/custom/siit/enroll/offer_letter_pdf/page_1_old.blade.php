<div class="word-page-style">
    ...
    <p>To accept SIIT’s offer of enrolment, please sign and return the attached “Offer Acceptance Form” and ensure fees are paid by <span class="has-text-danger">{{ $orderItem->intake_start_date->format('d/M/Y') }}</span></p>
