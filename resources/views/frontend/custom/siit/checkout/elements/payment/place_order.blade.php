...
<div class="" data-parent="#payment-method-list">
    <div class="card-body">
        <div class="field">
            <input type="order_number" name="order_number" class="input" placeholder="Required: Coupon Code">
            <small id="emailHelp" class="form-text text-muted">Please make sure your coupon code must be correct!</small>
        </div>
    </div>
</div>